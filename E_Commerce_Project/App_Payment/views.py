...
def payment(request):
    ...
    store_id = 'gobey5f2acdc38e8bc'
    API_key = 'gobey5f2acdc38e8bc@ssl'
    ...
    order_total = order_qs[0].get_totals()
    mypayment.set_product_integration(total_amount=Decimal(order_total), currency='BDT', product_category='Mixed', product_name=order_items, num_of_item=2, shipping_method='Courier', product_profile='None')

    current_user = request.user #user er ta
